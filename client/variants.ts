...
export const PIECE_FAMILIES: Record<string, PieceFamily> = {
    ...
    grasshopper: { pieceCSS: ["grasshopper0", "grasshopper1", "disguised"] },
...
export const VARIANTS: Record<string, Variant> = {
    ...
    'coregal': variant({
        name: "coregal", displayName: "coregal", tooltip: "King and Queen are both royal.",
        startFen: "rnbqkbnr/pppppppp/8/8/8/8/PPPPPPPP/RNBQKBNR w KQkq - 0 1",
        chess960: true, icon: "🧑‍🤝‍🧑", icon960: "🧑‍🤝‍🧑",
        boardFamily: "standard8x8", pieceFamily: "standard",
        pieceRow: ["k", "q", "r", "b", "n", "p"],
    ...
    shinobiplusmirror: variant({
        ...
        alternateStart: {
            '': '',
            'Original Shinobi': 'lh1ck1hl/pppppppp/8/8/8/8/PPPPPPPP/LH1CK1HL[LHMMDJlhmmdj] w - - 0 1',
        },
    }),
