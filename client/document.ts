...
export function changePieceCSS(assetUrl: string, family: string, cssFile: string) {
    ...
    switch (family) {
        ...
        case "grasshopperking": cssLinkIndex += 28; break;
        case "gethenian": cssLinkIndex += 29; break;
        case "shatranj": cssLinkIndex += 30; break;
        ...
        case "whaleshogi": cssLinkIndex += 35; break;
        ...
        case "wildebeest": cssLinkIndex += 40; break;
        case "reformedcourier": cssLinkIndex += 41; break;
        case "paradigm": cssLinkIndex += 42; break;
        case "yarishogi": cssLinkIndex += 43; break;
        case "schism": cssLinkIndex += 44; break;
        case "khansmirror": cssLinkIndex += 45; break;
        case "shaolinking": cssLinkIndex += 46; break;
        case "tetrarchy": cssLinkIndex += 47; break;
