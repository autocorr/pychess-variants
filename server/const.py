...
VARIANT_960_TO_PGN = {
    ...
    "grasshopperking": "Grasshopper King",
    "kinglet": "Kinglet",
    "losers": "Losers",
...
TRANSLATED_VARIANT_NAMES = {
    ...
    "epicatomic": _("Epic Atomic"),
    "extinction": _("Extinction"),
    "extinction960": _("Extinction 960"),
    "gethenian": _("Gethenian"),
    "grasshopper2": _("Grasshopper"),
    "grasshopper2960": _("Grasshopper 960"),
    ...
    "shaolinking": _("Shaolin King"),
    "shaolinking960": _("Shaolin King 960"),
    "shatranj": _("Shatranj"),
